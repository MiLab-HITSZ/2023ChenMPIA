classdef MPUAV4< handle
        ...
        function obj = MPUAV4(seed)
            ...
            obj.D = obj.data.dim;
            obj.encoding = 'real';
            obj.funname={'length','distance','fatal','noise'};
        end
        ...
        function [fit,trace_ijz]=Calobj(obj,x,data)
            ...
            fit=[tracelensum;distsum;risk_diesum;noise_impactsum];
