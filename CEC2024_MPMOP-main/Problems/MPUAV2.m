classdef MPUAV2< handle
        ...
        function obj = MPUAV2(seed)
            ...
            obj.D = obj.data.dim;
            obj.encoding = 'real';
            obj.funname={'length+height','distance','fatal','eco'};
        end
        ...
        function [fit,trace_ijz]=Calobj(obj,x,data)
            ...
            fit=[tracelensum+1*trace_heightsum;distsum;risk_diesum;risk_moneysum];
