classdef MPUAV1 < handle
        ...
        function obj = MPUAV1(seed)
            ...
            obj.D = obj.data.dim;
            obj.encoding = 'real';
            obj.funname = {'length','distance','fatal','eco'};
        end
