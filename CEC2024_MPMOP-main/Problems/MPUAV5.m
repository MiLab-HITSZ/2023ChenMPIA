classdef MPUAV5< handle
        ...
        function obj = MPUAV5(seed)
            ...
            obj.D = obj.data.dim;
            obj.encoding = 'real';
            obj.funname={'length+height','distance','fatal','noise'};
        end
        ...
        function [fit,trace_ijz]=Calobj(obj,x,data)
            ...
            fit=[tracelensum+trace_heightsum;distsum;risk_diesum;noise_impactsum];
