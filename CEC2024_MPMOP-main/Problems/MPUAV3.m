classdef MPUAV3< handle
        ...
        function obj = MPUAV3(seed)
            ...
            obj.D = obj.data.dim;
            obj.encoding = 'real';
            obj.funname={'fuel','distance','fatal','eco'};
        end
        ...
        function [fit,trace_ijz]=Calobj(obj,x,data)
            ...
            cosum = sum(trace_cos);
            fit=[cosum;distsum;risk_diesum;risk_moneysum];
