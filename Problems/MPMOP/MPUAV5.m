classdef MPUAV5< PROBLEM
% <problem> <MPMOP>
    methods
        %% Initialization
        function obj = MPUAV5(data)
            obj.Global.M = 4;
            ...
            obj.Global.fn = @callfit_5;
            obj.Global.funname={'length+height','distance','fatal','noise'};
            obj.Global.nonideal_VALUE = [9000 1000 0.07 0.5];
        end
