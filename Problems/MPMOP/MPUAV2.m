classdef MPUAV2< PROBLEM
% <problem> <MPMOP>
    methods
        %% Initialization
        function obj = MPUAV2(data)
            obj.Global.M = 4;
            ...
            obj.Global.fn = @callfit_2;
            obj.Global.funname={'length+height','distance','fatal','eco'};
            obj.Global.nonideal_VALUE = [8000 900 0.07 0.5];
        end
