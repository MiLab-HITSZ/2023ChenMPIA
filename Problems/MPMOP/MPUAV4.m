classdef MPUAV4< PROBLEM
% <problem> <MPMOP>
    methods
        %% Initialization
        function obj = MPUAV4(data)
            obj.Global.M = 4;
            ...
            obj.Global.fn = @callfit_4;
            obj.Global.funname={'length','distance','fatal','noise'};
            obj.Global.nonideal_VALUE = [9000 1200 0.07 0.5];
        end
