classdef MPUAV6< PROBLEM
% <problem> <MPMOP>
    methods
        %% Initialization
        function obj = MPUAV6(data)
            obj.Global.M = 4;
            ...
            obj.Global.fn = @callfit_6;
            obj.Global.funname={'fuel','distance','distance','noise'};
            obj.Global.nonideal_VALUE = [2500 1000 0.07 0.5];
        end
